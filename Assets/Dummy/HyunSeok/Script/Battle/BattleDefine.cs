...
namespace Battle
{
    public class BattleDefine
    {
        ...
        public enum ESkillTarget { Enemy, Me, TeamAll, TeamExceptMe, TeamBackAll, TeamBackOne, TeamFrontAll, TeamFrontOne, FrontAll, One, Two, Three, All, TeamRandom, TeamRandomTwo, End }
